...
void
Database::Servus::setDescription(const std::string& servusDescription)
{
    Primus::Database& database = Primus::Database::SharedInstance(Primus::Database::Default);
    ...
    try
    {
...

        {
            ...
            query.pushBIGINT(&servusIdQuery);
            query.pushVARCHAR(&servusDescription);
...
unsigned long
Database::Servus::DefineServus(const std::string& servusDescription)
{
